...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
MACRO_CONFIG_INT(SvAllowLocation, sv_allow_location, 1, 0, 1, CFGFLAG_SERVER, "Allow the server too look up locations")
MACRO_CONFIG_INT(SvNpcInScoreboard, sv_npc_in_scoreboard, 0, 0, 1, CFGFLAG_SERVER, "Allow the server too look up locations")
