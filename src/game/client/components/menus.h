...
class CMenus : public CComponent
{
	...
	int DoButton_Menu(const void *pID, const char *pText, int Checked, const CUIRect *pRect, const char *pTip = NULL, vec4 Color = vec4(1,1,1,0.5f), int Corners = CUI::CORNER_ALL);
	...
	*/
	...
	//found in mediaplayer
	void MediaRender(CUIRect MainView);
	void MediaRenderPlayList(CUIRect MainView);
	void MediaRenderTracks(CUIRect MainView);
	void MediaRenderControlPanel(CUIRect MainView);
	void PopupPlaylistRemove(CUIRect MainView);
	void PopupPlaylistAdd(CUIRect MainView);
	void PopupTrackAdd(CUIRect MainView);
