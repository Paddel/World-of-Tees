...
int CMenus::DoButton_Menu(const void *pID, const char *pText, int Checked, const CUIRect *pRect, const char *pTip, vec4 Color, int Corners)
{
	RenderTools()->DrawUIRect(pRect, Color*ButtonColorMul(pID), Corners, 5.0f);
	CUIRect Temp;
