...
public:
	...
	void AddPlayerItem(CPlayerItem *pPlayerItem, CMap *pMap);
    void RemovePlayerItem(CPlayerItem *pPlayerItem, CMap *pMap);
	void RemovePlayerItem(int Index, CMap *pMap);
	int GetPlayerItemId(CPlayerItem *pPlayerItem, CMap *pMap);
	int GetPlayerID(CPlayerItem *pPlayerItem);

	int GetPlayerID(CTargetAble *pTargetAble);
	void AddTargetAble(CTargetAble *pTarget, CMap *pMap);
	void RemoveTargetAble(CTargetAble *pTarget, CMap *pMap);
	CTargetAble *FindClosestTarget(vec2 Pos, float Radius, CTargetAble *pNotThis, bool CollisionCheck, CMap *pMap);
	CTargetAble *IntersectTarget(vec2 Pos0, vec2 Pos1, float Radius, vec2& NewPos, CTargetAble *pNotThis, CMap *pMap);
	...
	*/
	int FindEntities(vec2 Pos, float Radius, CEntity **ppEnts, int Max, int Type, CMap *pMap);
	...
	*/
	class CCharacter *ClosestCharacter(vec2 Pos, float Radius, CMap *pMap, CEntity *ppNotThis);
