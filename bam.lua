...
function build(settings)
	...
	generator = Compile(settings, Collect("src/engine/generator/*.cpp"))
	...
	client_exe = Link(client_settings, "teeworlds", game_shared, game_client,
		engine, client, generator, game_editor, zlib, pnglite, wavpack,
		client_link_other, client_osxlaunch)

	server_exe = Link(server_settings, "teeworlds_srv", engine, server, generator,
	...
	s = PseudoTarget("server".."_"..settings.config_name, server_exe, server_depends)
